...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    if(isset($_POST['submit'])){
        ...
        move_uploaded_file($tempname, './hotels/' . $filename);
        

    
    
        $sql = "INSERT INTO hotels (`hotel_name`,`hotel_address`,`hotel_phone`,`price`,`star`, `description`, `image`) VALUES ('$hotel_name', '$hotel_address', '$hotel_phone', '$price', '$star', '$description', '$filename')";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
       ...
       <br>
            <h1 style="font-size: 70px; color: red">Hotel Added Successfully</h1>
