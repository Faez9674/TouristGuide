...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    $id = $_GET['id'];
    $sql1 = "SELECT * FROM hotels WHERE id = '$id'";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
        <form action="hotel_review_add.php" method="POST" enctype="multipart/form-data">
            <div class="card-header" style="text-align: center; color: white; background-color: black;">
                <h2 style="font-size: 20px;">Add Hotel Review</h2><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="hotel_id" class="form-control" value="<?php echo $row1['id'] ?>" >
                    <input type="text" name="hotel_name" class="form-control" value="<?php echo $row1['hotel_name'] ?>" readonly>
