...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    $id = $_GET['id'];
    $sql1 = "SELECT * FROM touristplaces WHERE id = '$id'";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
        <form action="tour_review_add.php" method="POST" enctype="multipart/form-data">
            <div class="card-header" style="text-align: center; color: white; background-color: black;">
                <h2 style="font-size: 20px;">Add Tourist Place Review</h2><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="tour_id" class="form-control" value="<?php echo $row1['id'] ?>" >
                    <input type="text" name="tour_name" class="form-control" value="<?php echo $row1['tour_name'] ?>" readonly>
