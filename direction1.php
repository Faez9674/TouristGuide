...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    $sql = "SELECT * FROM restaurants WHERE id = '$id_data'";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-7" style="text-align: right;"><h2 style="font-size: 25px;">Restaurant Direction</h2> </div>
        ...
        <div class="form-group">
        <input type="text" class="form-control" value="<?php echo $row['restaurant_name'] ?>" placeholder="Destination Location" readonly>
            <input type="hidden" class="form-control" value="<?php echo $row['restaurant_address'] ?>" placeholder="Destination Location" id="dest">
        </div>
