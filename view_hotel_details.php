    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-5" style="text-align: right;"><a href="hotel_view.php" class="btn btn-danger">Back</a></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <a href="direction.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Direct</a>
                    <a href="hotel_review.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Give Rate/Review</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM hotel_review WHERE status = 'accepted' and hotel_id = $id";
