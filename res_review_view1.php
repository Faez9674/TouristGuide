...
$sql = "SELECT * FROM restaurant_review ORDER BY rate DESC";
...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-7" style="text-align: right;"><h2 style="font-size: 25px;">Restaurant Review Details</h2> </div>
    ...
    <table id="example">
        ...
        <tr>
            ...
            <td>
                <a href="res_review_accept.php?id=<?php echo $row['id'] ?>" class="btn btn-success">Accept</a>
                <a href="res_review_reject.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Reject</a>
            </td>
        </tr>
