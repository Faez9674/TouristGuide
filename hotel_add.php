...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
        <form action="hotel_submit.php" method="POST" enctype="multipart/form-data">
            <div class="card-header" style="text-align: center; color: white; background-color: black;">
                <h2 style="font-size: 20px;">Add Hotel</h2><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="hotel_address" class="form-control" placeholder="Enter Hotel Address" required>
                    
                    <label>Phone Number</label>
                    <input type="text" name="hotel_phone" class="form-control" placeholder="Enter Phone Number" required>
