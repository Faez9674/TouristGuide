...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    if(isset($_POST['submit'])){
        ...
        move_uploaded_file($tempname, './touristplaces/' . $filename);
        

    
    
        $sql = "INSERT INTO touristplaces (`tour_name`,`tour_address`,`star`, `description`, `image`) VALUES ('$tour_name', '$tour_address', '$star', '$description', '$filename')";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
       ...
       <br>
            <h1 style="font-size: 70px; color: red">Tourist Place Added Successfully</h1>
