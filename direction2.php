...
if(isset($_SESSION['id']) && $_SESSION['user_name'] && $_SESSION['email']){
    ...
    $sql = "SELECT * FROM touristplaces WHERE id = '$id_data'";
...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-md-7" style="text-align: right;"><h2 style="font-size: 25px;">Tourist Place Direction</h2> </div>
            ...
            <!-- <img src="location/park_area.png" width="700px" height="100px"> -->
        ...
        <div class="form-group">
        <input type="text" class="form-control" value="<?php echo $row['tour_name'] ?>" placeholder="Destination Location" readonly>
            <input type="hidden" class="form-control" value="<?php echo $row['tour_address'] ?>" placeholder="Destination Location" id="dest">
        </div>
