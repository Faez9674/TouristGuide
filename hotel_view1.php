...
$sql = "SELECT * FROM hotels ORDER BY star ASC";
...
<div class="card">
    ...
    <table id="example">
        ...
        <tr>
            ...
            <td><?php echo $row['hotel_phone'] ?></td>
            <td><?php echo $row['price'] ?></td>
            <td><?php echo $row['star'] ?></td>
            <td>
                <a href="view_hotel_details11.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">View Details</a>
            </td>
        </tr>
