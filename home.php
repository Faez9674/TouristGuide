...
<body>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">Travel & Tour</h1>
                              <p class="banner_text">Best Quality Tourism Services</p>
                              <div class="btn_main">
   ...
   <div class="services_section layout_padding">
      <div class="container">
         <h1 class="services_taital"><span style="color: #fcce2d">Best</span> Places In Burnley</h1>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Towneley Hall</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Thompson Park</div>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Turf Moor</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Singing Ringing Tree</div>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <div class="news_section layout_padding">
      <div class="container">
         ...
         <p class="news_text">Welcome to our website. We provide best quality Tourism Services in Burnley.</p>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="news_taital_box">
                     ...
                     <p class="lorem_text">We provides lots of services to all the persons in the world. We also provides best quality Tourism Services with minimul cost.</p>
            ...
            <div class="carousel-item">
               <div class="container">
                  ...
                  <div class="client_section_2">
                     ...
                     <div class="client_right">
                        <h3 class="client_name">Travelodge Burnley</h3>
            ...
            <div class="carousel-item">
               <div class="container">
                  ...
                  <div class="client_section_2">
                     ...
                     <div class="client_right">
                        <h3 class="client_name">Holiday Inn Express Burnley M65, JCT.10, an IHG Hotel</h3>
   ...
   <div class="newsletter_section layout_padding">
      <div class="container">
         <div class="newsletter_main">
            <h1 class="newsletter_taital">Get<br> Best Quality Service </h1>
          
         </div>
         <p class="dolor_text">A best and good quality services are provided to all the tourist all over the world. Foods and other services also provided to the tourist. </p>
      </div>
   </div>
            ...
            <div class="col-md-6 padding_left0">
               <div class="mail_section">
                  <div class="contact_img">
                     <h1 class="contact_taital">Best Quality Services in Burnley</h1>
                  </div>
               </div>
            </div>
            <div class="col-md-6">
