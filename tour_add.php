...
<div class="container">
    ...
    <div class="col-md-3"></div>
        ...
        <div class="card">
        <form action="tour_submit.php" method="POST" enctype="multipart/form-data">
            <div class="card-header" style="text-align: center; color: white; background-color: black;">
                <h2 style="font-size: 20px;">Add Tourist Place</h2><br>
            ...
            <div class="row">
                <div class="col-md-6">
                    <label>Tourist Place Name</label>
                    <input type="text" name="tour_name" class="form-control" placeholder="Enter Tourist Place Name" required>
                    <label>Tourist Place Address</label>
                    <input type="text" name="tour_address" class="form-control" placeholder="Enter Tourist Place Address" required>
